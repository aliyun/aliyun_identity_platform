#
#  Be sure to run `pod spec lint aliyun-identity-platform.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/freakishfox/aliyun-identity-platform.git", :tag => "#{spec.version}" }
